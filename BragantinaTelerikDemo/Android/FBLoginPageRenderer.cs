...
namespace BragantinaTelerikDemo.Android
{
    ...
    {
        public FBLoginPageRenderer(Context context)
        {
            ...
            auth.Completed += async (sender, eventArgs) => {
                if (eventArgs.IsAuthenticated)
                {
                    ...
                    var request = new OAuth2Request("GET", new Uri("https://graph.facebook.com/me?fields=id,name,picture&access_token=ACCESS_TOKEN"), null, eventArgs.Account);
